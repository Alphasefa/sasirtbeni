                  ...
                  >
                    <span className="flex items-center gap-2">
                      {selectedHolding && (
                        <img
                          src={
                            allHoldings.find((h) => h.code === selectedHolding)
                              ?.flag
                          }
                          alt=""
                            ...
                            {allHoldings
                              ...
                              .map((h) => (
                                <button
                                  ...
                                  className={`w-full px-8 py-2 text-left hover:bg-slate-100 dark:text-slate-200 dark:hover:bg-slate-600 ${
                                    selectedHolding === h.code
            ...
            <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="flex flex-col gap-4 sm:flex-row">
                ...
                <select
                  ...
                  onChange={(e) => setSelectedCityForCampaigns(e.target.value)}
                  className="rounded-lg border border-slate-200 px-4 py-2 dark:border-slate-600 dark:bg-slate-700 dark:text-white"
                >
            ...
            {sortedGeneralCampaigns.length > 0 && (
              <div className="mb-8">
                ...
                <p className="mb-4 text-slate-500 text-sm dark:text-slate-400">
                  Merkezi müdürlük tarafından tüm Türkiye'de geçerli kampanyalar
                </p>
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-4">
              {modelList.map((model: { id: string; name: string }) => (
                <Link
                  key={model.id}
                  href={`/compare/${selectedBrand}/${model.id}`}
